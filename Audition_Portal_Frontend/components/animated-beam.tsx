...
>(({ className, children }, ref) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex h-12 w-12 items-center justify-center rounded-full border-1 border-slate-400 bg-slate-600 backdrop-blur-xl p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
                className,
            )}
        >
            {children}
...
export function AnimatedBeamDemo() {
    ...
    return (
        <div
            className="relative flex w-full max-w-[500px] items-center justify-center overflow-hidden rounded-lg p-10 md:shadow-xl border border-1 border-slate-600 bg-white/10 backdrop-blur-lg shadow-lg"
            ref={containerRef}
        >
            <div className="flex h-full w-full flex-col items-stretch justify-between gap-10 bg-transparent">
